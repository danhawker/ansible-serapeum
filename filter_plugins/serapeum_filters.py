...
"""
Custom filters for use in Serapeum
These filters are a copy of openshift-ansible oo_filters.py
https://github.com/openshift/openshift-ansible/blob/master/filter_plugins/oo_filters.py
"""
import json
import os
import pdb
